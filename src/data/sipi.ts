...
export const REPRESENTACOES_LISTA = [
  {
    id: 1,
    ppe: "72921/2025",
    vitima: "Jose Vitor Carvalho de Jesus",
    investigado: "Ana Luiza Santos",
    data: "03/11/2025",
    tipo: "Outros",
    processo: "8001619-92.2025.8.05.0111",
    status: "Em análise",
  },
  {
    id: 2,
    ppe: "28259/2025",
    vitima: "Maria Angelina Resende de Jesus",
    investigado: "Silvanio Alves Lacerda",
    data: "03/11/2025",
    tipo: "Prisão Preventiva",
    processo: "8001618-10.2025.8.05.0111",
    status: "Aguardando Análise Judicial",
  },
  {
    id: 3,
    ppe: "118411/2025",
    vitima: "(Estado)",
    investigado: "Ionan G. Toscano de Britto; Vanderson Pena",
    data: "06/11/2025",
    tipo: "Prisão Temporária",
    processo: "8001651-97.2025.8.05.0111",
    status: "Indeferida",
  },
  {
    id: 4,
    ppe: "118411/2025",
    vitima: "(Estado)",
    investigado: "Ionan G. Toscano + 2",
    data: "06/11/2025",
    tipo: "Busca e Apreensão Domiciliar",
    processo: "8001651-97.2025.8.05.0111",
    status: "Cumprida (Positiva)",
  },
  {
    id: 5,
    ppe: "118411/2025",
...
export const INQUERITOS_AMOSTRA = [
  {
    ...
    dataFato: "25/06/2026",
    dias: 102,
    tipif: "MORTE POR INTERVENÇÃO DE AGENTE DE SEG. PÚBLICA",
    grav: "MIAE",
    tipo: "IP",
    reuPreso: false,
    bairro: "Bandeirante",
  ...
  },
  {
    ...
    dataFato: "10/04/2026",
    dias: -4,
    tipif: "TRÁFICO DE DROGAS (Art. 33 Lei 11.343/2006)",
    grav: "Drogas",
    tipo: "BOC",
    reuPreso: true,
    bairro: "Ouro Verde",
  ...
  },
  {
    ...
    dataFato: "06/04/2026",
    dias: -7,
    tipif: "FURTO QUALIFICADO C/ ROMPIMENTO DE OBSTÁCULO",
    grav: "Patrimônio",
    tipo: "APF",
    reuPreso: true,
    bairro: "Centro",
  ...
  },
  {
    ...
    dataFato: "01/04/2026",
    dias: 17,
    tipif: "DESOBEDIÊNCIA (Art. 330 CPB)",
    grav: "Outro",
    tipo: "TCO",
    reuPreso: false,
    bairro: "Centro",
  ...
  },
  {
    ...
    dataFato: "30/03/2026",
    dias: 18,
    tipif: "ESTUPRO DE VULNERÁVEL (Art. 217-A CPB)",
    grav: "Sexuais",
    tipo: "IP",
    reuPreso: false,
    bairro: "Centro",
  ...
  },
  {
    ...
    dataFato: "30/03/2026",
    dias: 16,
    tipif: "PERTURBAÇÃO DO TRABALHO OU DO SOSSEGO ALHEIO",
    grav: "Outro",
    tipo: "TCO",
    reuPreso: false,
    bairro: "Irmã Dulce",
  ...
  },
  {
    ...
    dataFato: "24/03/2026",
    dias: -11,
    tipif: "ADULTERAÇÃO DE SINAL DE VEÍCULO + RECEPTAÇÃO",
    grav: "Outro",
    tipo: "APF",
    reuPreso: true,
    bairro: "Zona Rural",
  ...
  },
  {
    ...
    dataFato: "22/03/2026",
    dias: -6,
    tipif: "ROUBO COM EMPREGO DE ARMA DE FOGO",
    grav: "Violento",
    tipo: "APF",
    reuPreso: true,
    bairro: "Ouro Verde",
  ...
  },
  {
    ...
    dataFato: "18/03/2026",
    dias: -17,
    tipif: "TRÁFICO DE DROGAS + PORTE ILEGAL DE ARMA",
    grav: "Drogas",
    tipo: "APF",
    reuPreso: true,
    bairro: "Pereirão",
  ...
  },
  {
    ...
    dataFato: "15/03/2026",
    dias: -2,
    tipif: "HOMICÍDIO QUALIFICADO POR EMBOSCADA",
    grav: "CVLI",
    tipo: "IP",
    reuPreso: false,
    bairro: "Village (Jaqueira)",
    status: "Em Andamento",
  },
  {
    ppe: "25872/2026",
  ...
  },
  {
    ...
    dataFato: "11/03/2026",
    dias: -2,
    tipif: "AMEAÇA — VIOLÊNCIA DOMÉSTICA CONTRA A MULHER",
    grav: "Vio. Doméstica",
    tipo: "IP",
    reuPreso: false,
    bairro: "Outros",
  ...
  },
  {
    ...
    dataFato: "09/03/2026",
    dias: -26,
    tipif: "POSSE IRREGULAR DE ARMA DE FOGO",
    grav: "Outro",
    tipo: "APF",
    reuPreso: true,
    bairro: "Zona Rural",
  ...
  },
  {
    ...
    dataFato: "09/03/2026",
    dias: -26,
    tipif: "FURTO QUALIFICADO MEDIANTE CONCURSO",
    grav: "Outro",
    tipo: "APF",
    reuPreso: true,
  ...
  },
  {
    ...
    dataFato: "27/02/2026",
    dias: -2,
    tipif: "IMPORTUNAÇÃO SEXUAL (Art. 215-A CPB)",
    grav: "Vio. Criança",
    tipo: "IP",
    reuPreso: false,
    bairro: "Outros",
